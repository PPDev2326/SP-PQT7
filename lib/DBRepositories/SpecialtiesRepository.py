...
class SpecialtiesRepository(ISpecialtyRepository):
    ...
    def _init_specialties(self):
        ...
        """
        specialties = {
            "AR": Specialty("ARQUITECTURA", "AR"),
            "ST": Specialty("ESTRUCTURAS", "ST"),
            "PL": Specialty("INSTALACIONES SANITARIAS", "PL"),
            "EE": Specialty("INSTALACIONES ELECTRICAS", "EE"),
            "DT": Specialty("COMUNICACIONES", "DT"),
            "ME": Specialty("INSTALACIONES MECANICAS", "ME")  # Corregido el sufijo
        }
